package com.jackyblackson.talkbubbles.util;

import java.util.List;

import com.jackyblackson.talkbubbles.TalkBubbles;
import com.jackyblackson.mixin.client.talkbubbles.DrawContextAccessor;
...
public class RenderBubble {
    ...
    private static final Identifier BACKGROUND = new Identifier("live-maid:textures/gui/background.png");
    ...
    public static void renderBubble(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, TextRenderer textRenderer, EntityRenderDispatcher entityRenderDispatcher,
        ...
        matrixStack.translate(0.0D, playerHeight + 0.9F + (backgroundHeight > 5 ? 0.1F : 0.0F) + LiveMaidClient.CONFIG.chatHeight, 0.0D);
        ...
        RenderSystem.setShaderColor(LiveMaidClient.CONFIG.backgroundRed, LiveMaidClient.CONFIG.backgroundGreen, LiveMaidClient.CONFIG.backgroundBlue, TalkBubbles.CONFIG.backgroundOpacity);
        ...
        for (int u = textList.size(); u > 0; u--) {
            ...
            textRenderer.draw(textList.get(u - 1), h, ((float) textList.size() + (u - textList.size()) * 9), LiveMaidClient.CONFIG.chatColor, false, matrix4f, vertexConsumerProvider,
